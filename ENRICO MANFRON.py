...
class Upper_Garment(Garment):
    def __init__(self, Bust_Length, Waist_Circumference, Limb_Circumference, Arm_Length, Chest_Width,
...
class Tshirt(Upper_Garment):
    def __init__(self, Bust_Length, Waist_Circumference, Limb_Circumference, Arm_Length, Chest_Width,
                 Neck_Circumference, Shoulder_Width):
        super().__init__(Bust_Length, Waist_Circumference, Limb_Circumference, Arm_Length, Chest_Width,
                         Neck_Circumference, Shoulder_Width)


class Hoodie(Upper_Garment):
    def __init__(self, Bust_Length, Waist_Circumference, Limb_Circumference, Arm_Length, Chest_Width,
                 Neck_Circumference, Shoulder_Width, Wrist_Circumference):
        super().__init__(Bust_Length, Waist_Circumference, Limb_Circumference, Arm_Length, Chest_Width,
                         Neck_Circumference, Shoulder_Width)
...
#  USER'S CLASS
class Customer:
    def __init__(self, Bust_Length=0, Leg_Length=0, Waist_Circumference=0, Arm_Length=0, Limb_Circumference=0,
                 Chest_Width=0, Neck_Circumference=0, Shoulder_Width=0, Calf_Circumference=0, Wrist_Circumference=0):
        self.Bust_Length = Bust_Length
        self.Leg_Length = Leg_Length
        self.Waist_Circumference = Waist_Circumference
        self.Arm_Length = Arm_Length
...
class UserInteraction:
    ...
    def start(hoodie_df, tshirt_df, pants_df):
        ...
        keys, values = zip(*top_5)

        plt.figure(figsize=(6, 4))
        sns.barplot(x=list(keys), y=list(values), palette="Blues_r")

        plt.title("Top 5 IDs by Value", fontsize=16)
